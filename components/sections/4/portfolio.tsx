    ...
    <Flex direction={"column"} alignItems={"center"}>
      ...
      >
        ...
        >
          ...
          creating robust backend, frontend, and mobile app solutions. I
          specialize in full deployment, setting up CI/CD, and ensuring secure
          SSL configurations.
        </Text>
      </Flex>
      ...
      <SimpleGrid columns={{ base: 1, md: 2 }} spacing="30px">
        <ProjectItem
          ...
          role="Developed the entire backend API connected to both the website and its dashboard."
          approach="Implemented a range of backend APIs and utilized RBAC for multiple user roles (ADMIN, RECEPTIONIST, USER). Incorporated email handling using Nodemailer for easy communication."
        ...
        <ProjectItem
          ...
          role="Developed the entire backend API."
          approach="Constructed backend APIs linked to the website and its dashboard, implemented RBAC for ADMIN and USER roles, and established comprehensive relations between different tables for movie and web series information."
        />
        <ProjectItem
        ...
        <ProjectItem
          ...
          role="Developed the entire backend APIs."
